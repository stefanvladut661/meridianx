...
- **Nu există export.** Importul (faza 5) fără export e un lock-in blând; un export în clar contrazice `crypto.ts` („nu adăuga funcții de export în clar"), deci varianta corectă e un fișier criptat cu o parolă de export (Argon2id + XChaCha20, același strat) — decizie de securitate de luat cu omul, după faza 6.
