  ...
  return (
    <div className="relative min-h-dvh">
      ...
      <header className="sticky top-0 z-30 border-b border-hair bg-ink/90 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-4 px-4 sm:px-8">
          <Link href="/admin/ads" className="flex items-center gap-2.5 text-bone">
            <Mark size={22} />
          ...
          <span aria-hidden className="h-4 w-px bg-hair-strong" />
          <AdsNav />
