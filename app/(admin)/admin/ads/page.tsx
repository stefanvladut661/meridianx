...
/**
 * /admin/ads — campaniile create din portal.
 *
 * FAZA 1: portalul nu vorbește încă cu nicio platformă și nu are tabelă
 * în bază, deci nu există nicio campanie de arătat. Ecranul gol e o
 * invitație (CLAUDE.md §4): spune ce va apărea aici și unde se face
 * prima campanie, plus starea tokenurilor — singurul lucru de configurat
 * înainte de faza 2.
 */
